...
export const PlanetList = [
  {
    ...
    descriptionEn:
      'Develop a mastery of precious metal investment, forge meaningful connections with industry peers, and collaboratively seize emerging market opportunities.',
...
export const PlanetListDeprecated = [
  {
    name: '瑞金星球',
